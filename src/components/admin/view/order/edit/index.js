...
handleUpdateStatus=async()=>{
    ...
    let data={id:this.state.id,status:this.state.status,deliverydate:new Date(this.state.deliverydate)}

    if (data) {
        let update= await getOrderList.getUpdateOrder(data);
                                                ...
                                                <div className="col-lg-6 col-sm-6">
                                                    {
                                                        self.row.Addresses.map((data, index) => (
                                                            <div className="ordr-date right-text" key={index}>
                                                                <b>Order Date :</b><Moment format='MMMM Do YYYY'>{data.createdAt}</Moment><br />
                                                                #{data.shipping},<br />
                                                                {data.area},<br />
                                                                {data.city},<br />
                                                                {data.discrict},<br />
