...
export default class Uploadphoto extends Component {
    ...
    async getProductList() {
        ...
        let list = await fetchProductDetails.getAllProductList();
        let imagelist = await fetchProductDetails.getAllProductPhoto();
        if (imagelist) {
    ...
    handleSearchProduct = async (event) => {
        ...
        this.setState({ isLoaded: true })
        let list = await fetchProductDetails.getProductById(this.state.selectedSearchProduct.value);
        if (list) {
    ...
    handleSubmit = event => {
        ...
        swal({
            ...
            .then(async (success) => {
                if (success) {
                    let list = await fetchProductDetails.getUploadProductImage(formData, config);
                    if (list) {
    ...
    async handlDeleteById(data) {
        ...
        swal({
            ...
            .then(async (success) => {
                if (success) {
                    let value = await fetchProductDetails.getProductPhotoDeleteById(list);
                    if (value) {
                        this.getProductList();
                ...
                <div className="row">
                    ...
                    <div className="col-lg-12 col-md-12">
                        ...
                        <div className="card card-static-2 mt-30 mb-30">
                          ...
                          <div className="my-4">
                                     <button className="view-btn hover-btn px-3 py-2" type="submit" onClick={()=>this.getProductList()}>View All</button>
                               </div>
                                </div>
                            </div>
